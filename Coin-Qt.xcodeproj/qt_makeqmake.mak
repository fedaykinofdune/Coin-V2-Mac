...
QMAKE    = /usr/bin/qmake
Coin-Qt.xcodeproj/project.pbxproj: coin-qt.pro  /usr/local/Qt4.8/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.8/mkspecs/common/unix.conf \
	...
	$(QMAKE) USE_UPNP=- USE_QRCODE=1 USE_IPV6=- -o Coin-Qt.xcodeproj/project.pbxproj coin-qt.pro
